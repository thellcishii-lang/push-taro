...
const STANDARD_PAYMENT_URL = process.env.NEXT_PUBLIC_SQUARE_LINK_TEST || '';
...
export async function POST(request: Request) {
  ...
  html: `
    ...
    <p><a href="${process.env.NEXT_PUBLIC_APP_URL}/payment/check?shopId=${shopId}" style="display:inline-block;padding:12px 24px;background:#0284c7;color:#fff;border-radius:6px;text-decoration:none;">決済画面へ進む</a></p>
