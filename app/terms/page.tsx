    ...
    <div style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif', color: '#2d3748', background: '#f8fafc', minHeight: '100vh', padding: '40px 20px', lineHeight: '1.8' }}>
      <div style={{ maxWidth: '850px', margin: '0 auto', background: '#fff', padding: '40px', borderRadius: '16px', border: '1px solid #e2e8f0', boxShadow: '0 4px 12px rgba(0,0,0,0.03)' }}>
        ...
        <p style={{ marginBottom: '24px', fontSize: '14px', color: '#4a5568' }}>
          この利用規約（以下、「本規約」といいます。）は、Push-taro（以下、「当サービス」といいます。）が提供する店舗向けWeb Push通知・CRMプラットフォームの利用条件を定めるものです。ご利用者様（以下、「ユーザー」といいます。）には、本規約に同意いただいた上で当サービスをご利用いただきます。
        </p>
        ...
        <section style={{ marginBottom: '24px' }}>
          ...
          <p style={{ fontSize: '14px', color: '#4a5568' }}>
            本規約は、ユーザーと当サービス運営者との間の当サービスの利用に関わる一切の関係に適用されるものとします。ユーザーが本サービスのお申し込みまたはご利用を開始した時点で、本規約の全条項に同意したものとみなします。
          </p>
        </section>
        ...
        <section style={{ marginBottom: '24px' }}>
          ...
          <ol style={{ fontSize: '14px', color: '#4a5568', paddingLeft: '20px' }}>
            <li>ユーザーは、当サービスが定める各プラン（ライトプラン: 1,980円/月、スタンダードプラン: 3,800円/月、プロプラン: 10,000円/月、いずれも税別）の利用料金を、当サービス指定の決済手段（Square等）により支払うものとします。</li>
        ...
        <section style={{ marginBottom: '24px' }}>
          ...
          <ol style={{ fontSize: '14px', color: '#4a5568', paddingLeft: '20px' }}>
            <li>運営者は、システムの定期保守・障害復旧・天災地変等の不可抗力により、事前に通知することなくサービスの全部または一部の提供を中断・停止することがあります。</li>
            <li>運営者は、事前にお客様へ通知（Webサイト上での告知等）を行うことにより、当サービスの内容を変更し、または提供を終了することができるものとします。</li>
          </ol>
        </section>
        ...
        <section style={{ marginBottom: '24px' }}>
          ...
          <ol style={{ fontSize: '14px', color: '#4a5568', paddingLeft: '20px' }}>
            ...
            <li>不正な自己紹介、虚偽アカウントの作成、その他不当な方法による成果報酬の発生が発覚した場合、運営者は即時に報酬支払いを取消し、アカウントを停止することができます。</li>
          </ol>
        </section>
        ...
        <section style={{ marginBottom: '24px' }}>
          ...
          <p style={{ fontSize: '14px', color: '#4a5568' }}>
            ユーザーが本規約のいずれかの条項に違反した場合、または利用料金の支払いを怠った場合、運営者は事前の催告なく即座にサービス利用の停止、あるいは契約を解除することができます。
          </p>
        </section>
        ...
        <section style={{ marginBottom: '24px' }}>
          ...
          <ol style={{ fontSize: '14px', color: '#4a5568', paddingLeft: '20px' }}>
            <li>運営者は、当サービスがユーザーの特定の目的に適合すること、期待する成果（集客数・売上向上等）が得られることを保証するものではありません。</li>
            <li>ブラウザ端末（iOS/Android/Chrome等）の仕様変更、通信事業者の障害等によりプッシュ通知が正常に不着となった場合、運営者はそれにより生じた損害について責任を負いません。</li>
            <li>運営者が損害賠償責任を負う場合であっても、過去1ヶ月間にユーザーが支払った利用料相当額を上限とします。</li>
          </ol>
        </section>
        ...
        <section style={{ marginBottom: '24px' }}>
          ...
          <p style={{ fontSize: '14px', color: '#4a5568' }}>
            ユーザーおよび運営者は、本サービスの提供・利用に関して知り得た相手方の非公表の情報を秘密に保持するものとします。個人情報の取扱いについては、別途定める「プライバシーポリシー」に従うものとします。
          </p>
        </section>
        ...
        <section style={{ marginBottom: '24px' }}>
          ...
          <p style={{ fontSize: '14px', color: '#4a5568' }}>
            運営者は、必要と判断した場合には、ユーザーに事前に適切な方法（Webサイト上の掲示等）で通知することにより、いつでも本規約を変更することができるものとします。変更後の規約は掲載された時点で効力を生じます。
          </p>
        </section>
        ...
        <section style={{ marginBottom: '24px' }}>
          ...
          <p style={{ fontSize: '14px', color: '#4a5568' }}>
            本規約の解釈にあたっては、日本法を準拠法とします。当サービスに関して紛争が生じた場合、運営者の本社所在地を管轄する裁判所を専属的合意管轄とします。
          </p>
        </section>
