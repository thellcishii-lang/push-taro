      ...
      <main style={{ maxWidth: '650px', margin: '0 auto', background: '#fff', padding: '36px', borderRadius: '16px', border: '1px solid #e2e8f0', boxShadow: '0 4px 12px rgba(0,0,0,0.05)' }}>
        ...
        <p style={{ fontSize: '11px', color: '#78350f', marginTop: '4px' }}>
          ...
          <div style={{
            ...
            <p style={{ margin: '0 0 8px 0' }}>1. ユーザーは、当サービスが定める各プラン（ライトプラン: 1,980円/月、スタンダードプラン: 3,800円/月、プロプラン: 10,000円/月、いずれも税別）の利用料金を、当社指定の決済手段（Square等）により支払うものとします。<br />2. 月の途中でアカウントの開通または解約が行われた場合であっても、日割り計算による返金・精算は行いません。</p>
